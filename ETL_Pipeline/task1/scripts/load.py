...
def create_table_if_not_exists():
    ...
    title TEXT
        ...
        try:
            ...
            print(f" Note: {e}")
            print("  Table will be created on first insert")
 
    except Exception as e:
        print(f" Error checking/creating table: {e}")
        print("  Trying to continue with data insertion...")
...
def load_to_supabase(staged_path: str, table_name: str = "titanic_data"):
    ...
    if not os.path.exists(staged_path):
        ...
        print("  Please run transform.py first to generate the transformed data")
        return
